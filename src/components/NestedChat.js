                                            ...
                                            <div ref={scrollRef} key={p._id}>
                                                ...
                                                :
                                                    <div  style={{textAlign:"right"}}>
                                                        <Message setMessages={setMessages} messages={messages} i1={i} rldPage={rld} isOwnMsg={true} props={p} deleteCB={deleteMsg} redactCB={redactMsg} />
                                                    </div>
                                                }
                                            </div>    
                                        )}
